		...
		spawn(function()
			...
			for i,v in pairs(game.Workspace.NEXUSBEAMS.GROUPB:GetChildren()) do
				...
				if v.Name == L1 then
					...
					v.Motors.Tilt.DesiredAngle = math.cos(Offset*16+x)+1.5707963267948966
				...
				if v.Name == L2 then
					...
					v.Motors.Tilt.DesiredAngle = math.cos(Offset*15+x)+1.5707963267948966

				end
				if v.Name == L3 then
 
					v.Motors.Tilt.DesiredAngle = math.cos(Offset*14+x)+1.5707963267948966

				end
				if v.Name == L4 then

					v.Motors.Tilt.DesiredAngle = math.cos(Offset*13+x)+1.5707963267948966

				end
				if v.Name == L5 then

					v.Motors.Tilt.DesiredAngle = math.cos(Offset*12+x)+1.5707963267948966

				end
				if v.Name == L6 then

					v.Motors.Tilt.DesiredAngle = math.cos(Offset*11+x)+1.5707963267948966

				end
				if v.Name == L7 then

					v.Motors.Tilt.DesiredAngle = math.cos(Offset*10+x)+1.5707963267948966

				end
				if v.Name == L8 then

					v.Motors.Tilt.DesiredAngle = math.cos(Offset*9+x)+1.5707963267948966
